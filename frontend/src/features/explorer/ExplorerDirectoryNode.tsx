...
function DirectoryNodeComponent({ data }: NodeProps) {
  ...
  return (
    <div 
      ...
      className={`relative group rounded-lg border ${rc.border} bg-synapse-panel/90 backdrop-blur-sm shadow-lg ${rc.glow} min-w-[260px] transition-all duration-200 hover:shadow-xl`}
    >
      ...
      <div className="flex items-center gap-2.5 px-3 py-2.5">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[10px] text-white/40 mt-0.5">
            ...
            {showComplexity && complexity > 0 && <span className="ml-1.5 text-white/30">· {complexity} cx</span>}
          </p>
        </div>
